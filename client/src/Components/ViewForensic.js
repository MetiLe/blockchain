                ...
                <div className="row">
                    <div className="col-sm-4">
                        <div className="form-group required">
                            ...
                            <input className="form-control" readOnly value = {crimeId} type="text" id="case_id" name="case_id" placeholder="Enter product id" onChange={(evt) => { this.state.case_id =  evt.target.value; }} required />
                        </div>
                    </div>
                </div>
                ...
                <div className="row">
                    <div className="col-sm-8">
                        <div className="form-group required">
                            ...
                            <input className="form-control" type="text" id="exhibit_name" name="exhibit_name" placeholder="Type and code of uploaded exhibit." onChange={(evt) => { this.state.exhibit_name =  evt.target.value; }} required />
                        </div>
                    </div>                    
                </div>
